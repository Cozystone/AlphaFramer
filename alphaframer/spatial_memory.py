...
The owner's second Jarvis axis (2026-07-12): the eye sees a room; later the human says "그때 그 방
어땠지?" and ATANOR REBUILDS that space — the objects where they were — as 3D particles in the orb.
...
# level on purpose so "방탄" never trips "방". Extend freely — a miss just means no replay.
_RECALL_CUES = (
